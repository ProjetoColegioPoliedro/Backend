...
public class TelaQuizInicialProf {
    private static final int LARGURA_ESQUERDA = 800;

    public TelaQuizInicialProf() {
        ...
        // Novo botão "Área restrita"
        BotaoArredondado areaRestrita = new BotaoArredondado("Área restrita", rosa, branco);
        painelDireito.add(areaRestrita);
        areaRestrita.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
        ...
        tela.addComponentListener(new ComponentAdapter() {
            ...
            public void componentResized(ComponentEvent e) {
                ...
                // Subindo os botões 40 pixels:
                int painelDireitoOffsetY = altura / 2 - 70 - 40;
                ...
                areaRestrita.setBounds(xCentral, painelDireitoOffsetY + 160, larguraBotao, alturaBotao);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new TelaQuizInicialProf());
    }
}