...
public class TelaMenuInicialAdmin extends JFrame{
    TelaMenuInicialAdmin(){
        ...
        var segundoIcone = new ImageIcon("poliedroFundoBranco.png");
        ...
        areaRestrita.setBounds(870, 520, 400, 80); 
        areaRestrita.setBackground(rosa);
        areaRestrita.setForeground(Color.WHITE);
