...
public class TelaPartida extends JFrame{
    TelaPartida(){
        ...
        var errar = new ImageIcon("retanguloLateral.png");
        ...
        var acertar = new ImageIcon("retanguloLateral.png");
        ...
        // Cronômetro
        var circuloCrono = new ImageIcon("circuloCrono.png");
        ...
        Timer timer = new Timer(1000, e ->{
            ...
            if(segundos[0]>0){
                segundos[0]--;
                cronometro.setText(String.format("%02d", segundos[0]%60));
            }
